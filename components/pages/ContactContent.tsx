    ...
    <div className="pt-10 min-h-[70vh] flex flex-col justify-center">
      <Section className="max-w-4xl mx-auto text-center">
        ...
        >
           ...
           <p className="text-xl text-muted mb-12 max-w-2xl mx-auto text-white/60">
             Whether you have a clear vision or just a rough idea, I'm here to help you build a solution that works.
           </p>

           <div className="flex flex-col md:flex-row gap-6 justify-center items-center">
              <Link href={`https://wa.me/${portfolio.personal.phone.replace('+', '')}`} target="_blank">
                <Button size="lg" className="rounded-full px-8 h-14 text-lg w-full md:w-auto text-white/90">
                  <Phone className="mr-3 text-secondary" size={20} />
                  Chat on WhatsApp
                </Button>
              </Link>
              
              <Link href={`mailto:${portfolio.personal.email}`}>
                <Button variant="outline" size="lg" className="rounded-full px-8 h-14 text-lg w-full md:w-auto text-white/90">
           ...
           <div className="mt-20 p-8 border border-white/5 rounded-2xl bg-card/30 inline-block text-left max-w-lg">
             ...
             <ul className="space-y-4 text-muted text-sm md:text-base text-white/60">
               <li className="flex items-start">
                 ...
                 A brief chat to understand your needs.
               </li>
               <li className="flex items-start">
               ...
               <li className="flex items-start">
                 ...
                 Start building your new digital presence.
               </li>
             </ul>
           </div>
        </motion.div>
